# luban-mall-请关注项目更新及时拉取最新版本

## 项目介绍

`luban-mall`是一套微服务商城系统，采用了 Spring Boot 2、MyBatis、Docker、Elasticsearch等核心技术，同时提供了基于Vue的管理后台方便快速搭建系统。 
...
├── mb-generator -- MyBatisGenerator生成的数据库操作代码模块
