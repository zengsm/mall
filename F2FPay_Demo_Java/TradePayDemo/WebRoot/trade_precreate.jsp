...
<%@ page import="Configs"%>
<%@ page import="AlipayTradePrecreateRequestBuilder"%>
<%@ page import="AlipayTradeService" %>
<%@ page import="AlipayTradeServiceImpl" %>
<%@ page import="ZxingUtils" %>
<%@ page import="java.io.File" %>
<%@ page import="ExtendParams" %>
<%@ page import="GoodsDetail" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="AlipayF2FPrecreateResult" %>
