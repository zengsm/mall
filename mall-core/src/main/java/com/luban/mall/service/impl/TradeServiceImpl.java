...
import com.luban.mall.mapper.OmsOrderMapper;
import com.luban.mall.model.OmsOrder;
import com.luban.mall.model.OmsOrderItem;
import com.luban.mall.component.TradePayProp;
...
import com.luban.mall.component.trade.alipay.model.builder.AlipayTradePrecreateRequestBuilder;
import com.luban.mall.component.trade.alipay.model.builder.AlipayTradeQueryRequestBuilder;
...
import com.luban.mall.dao.PortalOrderDao;
...
public class TradeServiceImpl implements TradeService {
    ...
    public CommonResult tradeQrCode(Long orderId, Integer payType) {
        ...
        String path =  (payType == 1) ? aliPayQrCode(detail) : wechatPayQrCode(detail);
        return StringUtils.isNotEmpty(path)
                ? CommonResult.success(path)
                : CommonResult.failed();
    }
    ...
    private String aliPayQrCode(OmsOrderDetail orderDetail){
        ...
        String storeId = "bole-shop";

        // 业务扩展参数，目前可添加由支付宝分配的系统商编号(通过setSysServiceProviderId方法)，详情请咨询支付宝技术支持
        ExtendParams extendParams = new ExtendParams();
        extendParams.setSysServiceProviderId("2088102181433645");
